...
<head>
    ...
    <title>Cash Receipt Register | FuelTracker</title>
    ...
    <style>
        html[data-theme] .cashreceipt-register-page .entries-toggle {
        ...
        html[data-theme] .cashreceipt-register-page .entries-toggle:hover,
        html[data-theme] .cashreceipt-register-page .entries-toggle:focus {
        ...
        html[data-theme] .cashreceipt-register-page .entries-dropdown::after {
            border-top-color: var(--primary) !important;
        }

        html[data-theme] .cashreceipt-register-page .entries-menu {
            border-color: color-mix(in srgb, var(--primary) 35%, var(--line)) !important;
            box-shadow: 0 18px 38px var(--theme-glow) !important;
        }

        html[data-theme] .cashreceipt-register-page .entries-option:hover,
        html[data-theme] .cashreceipt-register-page .entries-option:focus,
        html[data-theme] .cashreceipt-register-page .entries-option.is-selected {
        ...
        .cashreceipt-register-page .list-panel {
            overflow: hidden;
            max-width: 100%;
        }

        .cashreceipt-register-page .toolbar {
            position: relative;
            z-index: 40;
        }

        .cashreceipt-register-page .entries-menu {
            z-index: 80;
        }
    </style>
...
<body>
    ...
    return route('RegisterCashReceiptFilter', [
    'search' => $search,
    ...
    <div
        class="app-shell-with-sidebar dayfuel-register-workspace cashreceipt-register-workspace"
        id="dashboardPage">

        @include('partials.fueltracker-menu')

        <main class="dayfuel-register-page cashreceipt-register-page">
                ...
                <section class="list-panel">
                    ...
                    <div class="toolbar">
                        ...
                        <form
                            class="search-form"
                            method="GET"
                            action="{{ route('RegisterCashReceiptFilter') }}">
                            ...
                            <input
                                ...
                                name="search"
                                value="{{ $search }}"
                                placeholder="Search item, slip no, narration...">
                            ...
                            <a
                                href="{{ route('RegisterCashReceiptFilter') }}"
                                class="reset-btn">
                        ...
                        <div class="toolbar-actions">
                            ...
                            <a
                                href="{{ route('RegisterCashReceiptFilter.pdf', request()->query()) }}"
                                class="new-btn"
                                target="_blank"
                                rel="noopener"
                                data-themed-export>
                            ...
                            <a
                                href="{{ route('RegisterCashReceiptFilter.excel', request()->query()) }}"
                                class="new-btn"
                                data-themed-export>
                        ...
                        <table>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="{{ in_array($column, ['rate', 'amount'], true) ? 'number-cell' : '' }}">
