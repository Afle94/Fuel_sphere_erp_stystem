...
<head>
    ...
    <title>Product Master Creation | FuelTracker</title>
...
<body>
    <header class="site-header">
        <div class="site-header-inner">
            ...
            <div class="header-title">Product Master Creation</div>
    ...
    <div class="product-workspace account-master-workspace" id="dashboardPage">
        ...
        <main class="product-page">
            <section class="page-title" aria-labelledby="productMasterTitle">
                <div>
                    <p class="eyebrow">Masters</p>
                    <h1 id="productMasterTitle">Product Details</h1>
                </div>
                <a href="{{ route('product.list') }}" class="view-list-btn">View List</a>
            </section>

            <div class="content-grid">
                <form class="panel form-panel" id="productForm" method="POST" action="{{ route('product.create') }}" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-grid">
                        <div class="field">
                            ...
                            <input type="text" id="productName" name="Product_Name" placeholder="Enter product name" maxlength="255" value="{{ old('Product_Name') }}" data-show-limit data-limit-unit="characters" required>
                        </div>

                        <div class="field">
                            <label for="hsn">HSN Code</label>
                            <input type="text" id="hsn" name="HSN" placeholder="Enter HSN code" maxlength="255" value="{{ old('HSN') }}">
                        ...
                        <div class="field">
                            ...
                            <input type="number" id="gstPer" name="GST_per" placeholder="Enter GST percentage" min="0" step="0.01" value="{{ old('GST_per') }}">
                            <span class="field-align-spacer" aria-hidden="true"></span>
                        </div>

                        <div class="field">
                            <label for="purchaseRate">Purchase Rate</label>
                            <input type="number" id="purchaseRate" name="Purchase_rate" placeholder="Enter purchase rate" min="0" step="0.01" value="{{ old('Purchase_rate') }}">
                            <span class="field-align-spacer" aria-hidden="true"></span>
                        </div>

                        <div class="field">
                            <label for="openingStock">Opening Stock</label>
                            <input type="number" id="openingStock" name="opening_stock" placeholder="Enter opening stock quantity" min="0" step="1" value="{{ old('opening_stock') }}">
                            <span class="field-align-spacer" aria-hidden="true"></span>
                        </div>

                        <div class="field">
                            <label for="openingStockValue">Opening Stock Value</label>
                            <input type="number" id="openingStockValue" name="opening_stock_value" placeholder="Enter opening stock value" min="0" step="0.01" value="{{ old('opening_stock_value') }}">
                            <span class="field-align-spacer" aria-hidden="true"></span>
                        </div>
                    </div>
                    ...
                    <p class="form-note">
                        <strong>Note</strong>
                        Create and manage product masters here including fuel, lubricants, spare parts and services with their HSN codes, GST rates, purchase rates and opening stock details.
                    </p>
                </form>
