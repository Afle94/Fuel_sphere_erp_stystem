...
<head>
    ...
    <title>Cheque Payment Register | FuelTracker</title>
...
<body>
    ...
    $sortUrl = function (string $column) use ($sort, $direction, $search, $perPage) {
        return route('RegisterChequePaymentFilter', [
            'search'    => $search,
    ...
    <div
        ...
        <main class="dayfuel-register-page">
            ...
            <div class="list-shell">
                ...
                <section
                    class="page-title"
                    aria-labelledby="chequePaymentRegisterTitle">
                    ...
                    <div>
                        ...
                        <h1 id="chequePaymentRegisterTitle">
                            Cheque Payment Register
                        </h1>
                ...
                <section class="list-panel">
                    ...
                    <div class="toolbar">
                        ...
                        <form
                            class="search-form"
                            method="GET"
                            action="{{ route('RegisterChequePaymentFilter') }}">
                            ...
                            <a
                                href="{{ route('RegisterChequePaymentFilter') }}"
                                class="reset-btn">
                        ...
                        <div class="toolbar-actions">
                            ...
                            <a
                                href="{{ route('RegisterChequePaymentFilter.pdf', request()->query()) }}"
                                class="new-btn"
                                target="_blank"
                                rel="noopener"
                                data-themed-export>
                            ...
                            <a
                                href="{{ route('RegisterChequePaymentFilter.excel', request()->query()) }}"
                                class="new-btn"
                                data-themed-export>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="date-cell">
                                        {{ $entry->cheque_date ? \Carbon\Carbon::parse($entry->cheque_date)->format('d M Y') : '-' }}
                                    </td>
