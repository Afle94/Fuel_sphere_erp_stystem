...
<head>
    ...
    <title>Credit Sales Register | FuelTracker</title>
    ...
    <style>
        ...
        * {
        ...
        .creditsales-register-workspace.app-shell-with-sidebar {
        ...
        .creditsales-register-workspace.app-shell-with-sidebar.menu-collapsed {
            grid-template-columns: 64px minmax(0, 1fr);
        }

        .creditsales-register-page {
            min-width: 0;
            padding: 14px;
        }
        ...
        .search-form {
            ...
            display: grid;
            grid-template-columns:
                minmax(180px, 1fr) minmax(132px, .55fr) minmax(132px, .55fr) 74px 66px 116px;
            align-items: center;
            gap: 8px;
            min-width: 0;
        }
    ...
    <style>
        html[data-theme] .creditsales-register-page .entries-toggle {
        ...
        html[data-theme] .creditsales-register-page .entries-toggle:hover,
        html[data-theme] .creditsales-register-page .entries-toggle:focus {
        ...
        html[data-theme] .creditsales-register-page .entries-dropdown::after {
            border-top-color: var(--primary) !important;
        }

        html[data-theme] .creditsales-register-page .entries-menu {
            border-color: color-mix(in srgb, var(--primary) 35%, var(--line)) !important;
            box-shadow: 0 18px 38px var(--theme-glow) !important;
        }

        html[data-theme] .creditsales-register-page .entries-option:hover,
        html[data-theme] .creditsales-register-page .entries-option:focus,
        html[data-theme] .creditsales-register-page .entries-option.is-selected {
        ...
        .creditsales-register-page .list-panel {
            overflow: hidden;
            max-width: 100%;
        }

        .creditsales-register-page .toolbar {
            position: relative;
            z-index: 40;
            max-width: 100%;
        }

        .creditsales-register-page .entries-menu {
            z-index: 80;
        }

        .creditsales-register-page .table-wrap {
            width: 100%;
            max-width: 100%;
            overflow: auto;
...
<body>
    ...
    return route('creditsalesregisterfilter', [
    ...
    <div
        class="app-shell-with-sidebar creditsales-register-workspace"
        id="dashboardPage">

        @include('partials.fueltracker-menu')

        <main class="creditsales-register-page">

            <div class="list-shell">

                <section
                    class="page-title"
                    aria-labelledby="creditSalesRegisterTitle">
                    ...
                    <div>
                        ...
                        <h1 id="creditSalesRegisterTitle">
                            Credit Sales Register
                        </h1>
                ...
                <section class="list-panel">
                    ...
                    <div class="toolbar">
                        ...
                        <form
                            class="search-form"
                            method="GET"
                            action="{{ route('creditsalesregisterfilter') }}">
                            ...
                            <input
                                ...
                                name="search"
                                value="{{ $search }}"
                                placeholder="Search party, vehicle, item or slip no">
                            ...
                            <a
                                href="{{ route('creditsalesregisterfilter') }}"
                                class="reset-btn">
                        ...
                        <div class="toolbar-actions">
                            ...
                            <a
                                href="{{ route('creditsalesregister.pdf', request()->query()) }}"
                                class="new-btn"
                                target="_blank"
                                rel="noopener"
                                data-themed-export>
                            ...
                            <a
                                href="{{ route('creditsalesregister.excel', request()->query()) }}"
                                class="new-btn"
                                data-themed-export>
                        ...
                        <table>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="{{ in_array($column, ['quantity', 'rate', 'amount'], true) ? 'number-cell' : '' }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="number-cell">
                                        {{ is_numeric($entry->quantity) ? number_format($entry->quantity, 2) : '-' }}
                                    </td>

                                    <td class="number-cell">
                                        {{ is_numeric($entry->rate) ? number_format($entry->rate, 2) : '-' }}
                                    </td>
