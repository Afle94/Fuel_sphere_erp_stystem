...
<head>
    ...
    <title>Cash Payment Register | FuelTracker</title>
...
<body>
    ...
    return route('RegisterCashPaymentFilter', [
    'search' => $search,
    ...
    <div
        ...
        <main class="dayfuel-register-page">
            ...
            <div class="list-shell">
                ...
                <section
                    class="page-title"
                    aria-labelledby="cashPaymentRegisterTitle">
                    ...
                    <div>
                        ...
                        <h1 id="cashPaymentRegisterTitle">
                            Cash Payment Register
                        </h1>
                ...
                <section class="list-panel">
                    ...
                    <div class="toolbar">
                        ...
                        <form
                            class="search-form"
                            method="GET"
                            action="{{ route('RegisterCashPaymentFilter') }}">
                            ...
                            <a
                                href="{{ route('RegisterCashPaymentFilter') }}"
                                class="reset-btn">
                        ...
                        <div class="toolbar-actions">
                            ...
                            <a
                                href="{{ route('RegisterCashPaymentFilter.pdf', request()->query()) }}"
                                class="new-btn"
                                target="_blank"
                                rel="noopener"
                                data-themed-export>
                            ...
                            <a
                                href="{{ route('RegisterCashPaymentFilter.excel', request()->query()) }}"
                                class="new-btn"
                                data-themed-export>
