...
<head>
    ...
    <title>Cash Sales Register | FuelTracker</title>
    ...
    <style>
        ...
        * {
        ...
        .cashsales-register-workspace.app-shell-with-sidebar {
        ...
        .cashsales-register-workspace.app-shell-with-sidebar.menu-collapsed {
            grid-template-columns: 64px minmax(0, 1fr);
        }

        .cashsales-register-page {
            min-width: 0;
            padding: 14px;
        }
    ...
    <style>
        html[data-theme] .cashsales-register-page .entries-toggle {
        ...
        html[data-theme] .cashsales-register-page .entries-toggle:hover,
        html[data-theme] .cashsales-register-page .entries-toggle:focus {
        ...
        html[data-theme] .cashsales-register-page .entries-dropdown::after {
            border-top-color: var(--primary) !important;
        }

        html[data-theme] .cashsales-register-page .entries-menu {
            border-color: color-mix(in srgb, var(--primary) 35%, var(--line)) !important;
            box-shadow: 0 18px 38px var(--theme-glow) !important;
        }

        html[data-theme] .cashsales-register-page .entries-option:hover,
        html[data-theme] .cashsales-register-page .entries-option:focus,
        html[data-theme] .cashsales-register-page .entries-option.is-selected {
        ...
        .cashsales-register-page .list-panel {
            overflow: hidden;
            max-width: 100%;
        }

        .cashsales-register-page .toolbar {
            position: relative;
            z-index: 40;
        }

        .cashsales-register-page .entries-menu {
            z-index: 80;
        }
    </style>
...
<body>
    ...
    $sortUrl = function (string $column) use ($sort, $direction, $search, $perPage) {
        return route('cashsalesregisterfilter', [
            'search' => $search,
    ...
    <div
        class="app-shell-with-sidebar cashsales-register-workspace"
        id="dashboardPage">

        @include('partials.fueltracker-menu')

        <main class="cashsales-register-page">

            <div class="list-shell">

                <section
                    class="page-title"
                    aria-labelledby="cashSalesRegisterTitle">
                ...
                <section class="list-panel">
                    ...
                    <div class="toolbar">
                        ...
                        <form
                            class="search-form"
                            method="GET"
                            action="{{ route('cashsalesregisterfilter') }}">
                            ...
                            <input
                                ...
                                name="search"
                                value="{{ $search }}"
                                placeholder="Search item, slip or ref no">
                            ...
                            <a
                                href="{{ route('cashsalesregisterfilter') }}"
                                class="reset-btn">
                        ...
                        <div class="toolbar-actions">
                            ...
                            <a
                                href="{{ route('cashsalesregister.pdf', request()->query()) }}"
                                class="new-btn"
                                target="_blank"
                                rel="noopener"
                                data-themed-export>
                            ...
                            <a
                                href="{{ route('cashsalesregister.excel', request()->query()) }}"
                                class="new-btn"
                                data-themed-export>
