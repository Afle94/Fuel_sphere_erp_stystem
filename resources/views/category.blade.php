...
<head>
    ...
    <title>Category Master Creation | FuelTracker</title>
...
<body>
    <header class="site-header">
        <div class="site-header-inner">
            ...
            <div class="header-title">Category Master Creation</div>
    ...
    <div class="category-workspace account-master-workspace" id="dashboardPage">
        ...
        <main class="category-page">
            <section class="page-title" aria-labelledby="categoryMasterTitle">
                <div>
                    <p class="eyebrow">Masters</p>
                    <h1 id="categoryMasterTitle">Category Details</h1>
                </div>
                <a href="{{ route('category.list') }}" class="view-list-btn">View List</a>
            </section>

            <div class="content-grid">
                <form class="panel form-panel" id="categoryForm" method="POST" action="{{ route('category.create') }}" autocomplete="off">
                    @csrf
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="categoryName" name="Category_Name" placeholder="Enter category name" maxlength="50" value="{{ old('Category_Name') }}" data-show-limit data-limit-unit="characters" required>
                    </div>
                    ...
                    <p class="form-note">
                        <strong>Note</strong>
                        Create fuel, lubricant, spare, service, and other item categories here so product masters and reports stay organized.
                    </p>
                </form>
