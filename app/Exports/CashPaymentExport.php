...
class CashPaymentExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithCustomStartCell, ShouldAutoSize
{
    use AppliesReportHeading;

    public function __construct(private Collection $cashpayments, private string $selectedDate, private array $theme = [])
    {
