...
class CashSalesExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithCustomStartCell, ShouldAutoSize
{
    use AppliesReportHeading;

    public function __construct(private Collection $cashsales, private string $selectedDate, private array $theme = [])
    {
    ...
    {
        return ['Date', 'Ref No.', 'Slip No.', 'Item', 'Qty', 'Rate', 'Amount', 'Narration'];
    }
