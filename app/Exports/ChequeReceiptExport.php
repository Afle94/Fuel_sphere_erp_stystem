...
class ChequeReceiptExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithCustomStartCell, ShouldAutoSize
{
    use AppliesReportHeading;

    public function __construct(private Collection $chequereceipts, private string $selectedDate, private array $theme = [])
    {
    ...
    public function map($receipt): array
    {
        return [
            ...
            $receipt->slip_no,
            $receipt->cheque_no,
            substr((string) $receipt->datet, 0, 10),
            $receipt->credit,
            $receipt->debit,
