...
class NozzleExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, WithCustomStartCell, ShouldAutoSize
{
    ...
    {
        return Nozzle::orderBy('Nozzle_Name')->get();
    }

    public function title(): string
    {
        return 'Nozzle Master';
    }
    ...
    public function map($nozzle): array
    {
        return [
            $nozzle->id,
            $nozzle->Nozzle_Name,
            $nozzle->Item,
            optional($nozzle->Open_Date)->format('d M Y') ?: '-',
            optional($nozzle->Close_Date)->format('d M Y') ?: '-',
            optional($nozzle->created_at)->format('d M Y') ?: '-',
            optional($nozzle->updated_at)->format('d M Y') ?: '-',
        ];
    }
